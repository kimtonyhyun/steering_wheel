...
if sigma>0
    Range=400;%カ?[ネルテンプレ?[トの片側ピクセル??B?ﾅ後の方はほとんどゼ?であることが望ましい?BあまりRangeが大きいと解?ﾍの時間ばっかり?Hうのではないか?B
    ...
    Kernel_gain;
    %デ?[タの値に実?ﾛのゲインをかける?B個?Xのデ?[タ点についてル?[プでどんどん計算していく
    if dimen==1
